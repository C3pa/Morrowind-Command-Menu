- Additional ideas:
 - Big features:
  ...
  - Kill stats editor: using tes3.decrementKillCount, tes3.getKillCount, tes3.getKillCounts, tes3.incrementKillCount, tes3.setKillCount, also werewolf kill stats: tes3.setWerewolfKillCount
 ...
 - Player:
  ...
  - Restore all damaged attributes and skills.
 ...
 - Respawn organic containers - maybe this can be implemented by doing tes3.worldController.monthsToRespawn = 0
 - Time:
  - tes3.advanceTime
